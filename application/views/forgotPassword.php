...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Lupa Kata Sandi | Sistem Penjaminan Mutu</title>
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="#">Sistem<br><b>Penjaminan Mutu</b></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form action="<?php echo base_url(); ?>resetPasswordUser" method="post">
          <div class="form-group has-feedback">
            <input type="email" class="form-control" placeholder="Email Anda" name="login_email" required />
        ...
        <a href="<?php echo base_url() ?>">Masuk Sekarang</a><br>
      </div><!-- /.login-box-body -->
    </div><!-- /.login-box -->
